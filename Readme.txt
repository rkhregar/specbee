Custom Module Task Description
...
Add a Plugin block which will render the Location from the configuration set in the ACF 
and the current time calling the service in the previous step. Pass the variables to a template to be rendered.



/*********************************************************/

Upon installing this module 2 date formats will be added in date and time formats, that are set to locked
